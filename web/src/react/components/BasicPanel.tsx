...
export function BasicPanel() {
  ...
  else if (panel === 'data') content = dsmStepsStore.isOpen ? <LegacySvelteSurface component={StepWizard} /> : <DataTable syncBasicPanel initialTab={dataTab} />;
  else if (panel === 'advanced') content = <><ToolbarAdvanced flat /><div ref={outputRef}><LegacySvelteSurface component={KinematicPanel} props={{ docked: true }} /><LegacySvelteSurface component={WhatIfPanel} props={{ docked: true }} /><LegacySvelteSurface component={SectionStressPanel} props={{ docked: true }} /></div></>;
